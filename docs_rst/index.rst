...
Contributions to Monty are always welcome. Feel free to visit the `Megnet
Github repo <https://github.com/materialsvirtuallab/megnet>`_ to fork the
repo or to submit Issues.

License
=======

Megnet is released under the BSD-3 Clause License. The terms of the license are as
follows:
