...
#fake_lines <- data.frame(Model=c("2-fi", "4-fi", "1-fi-s"),
 #                        Fidelity=c("PBE", "SCAN", "PBE"),
#                         Error=c(1000, 1000, 1000),
#                         split=c(0, 0, 0))

#data2 = data.frame(cate=c("PBE", "GLLB-SC", "SCAN", "HSE", "Exp"))
...
ggsave('mf.pdf', plot=p, height = 4.5, width = 8)
print(p)
